...
SUBJECTS = [
    {
        "key": "corp_finance",
        "column": "Corp. Finance",
        "titles": {"ru": "Корпоративные финансы", "en": "Corporate Finance"},
        "kind": "cohort",
        "match": [
    ...
    },
    {
        ...
        "titles": {"ru": "Организационное поведение", "en": "Organizational Behaviour"},
        "kind": "cohort",
        "match": [
    ...
    },
    {
        ...
        "titles": {"ru": "Количественные методы, лекции", "en": "QMBR, lectures"},
        "kind": "cohort",
        "match": [
    ...
    },
    {
        ...
        "titles": {"ru": "Количественные методы, семинары", "en": "QMBR, seminars"},
        "kind": "cohort",
        "match": [
            "количественные методы исследований",
            "количественных методов исследований",
    ...
    },
    {
        "key": "rs_1",
        "column": "RS I",
        "titles": {"ru": "Исследовательский семинар I", "en": "Research Seminar I"},
        "kind": "group",
        "match": [
    ...
    },
    {
        "key": "ccm",
        "column": "CCM",
        "titles": {"ru": "Кросс-культурный менеджмент", "en": "Cross-Cultural Management"},
        # С осени 2026 деканат делит курс на когорты, а не на три группы
        "kind": "cohort",
        "match": [
    ...
    {
        # На сайте предмет называется «Профессиональные навыки менеджера I»
        "key": "mps_1",
        "column": "MPS I",
        "titles": {
            "ru": "Профессиональные навыки менеджера I",
            "en": "Managerial and Professional Skills I",
        },
        "kind": "educator",
        "match": [
